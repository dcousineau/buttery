...
export interface AdminAdminAccount {
  accessToken: string | null;
  accessTokenExpiresAt: Timestamp | null;
  accountId: string;
  createdAt: Generated<Timestamp>;
...
export interface AdminAdminSession {
  createdAt: Generated<Timestamp>;
  expiresAt: Timestamp;
  id: string;
...
export interface AdminAdminVerification {
  createdAt: Generated<Timestamp>;
  expiresAt: Timestamp;
  id: string;
  identifier: string;
...
export interface AdminAtprotoRecordRevision {
  action: string;
  cid: string;
  collection: string;
  did: string;
...
export interface DB {
  account: Account;
  "admin.admin_account": AdminAdminAccount;
  "admin.admin_session": AdminAdminSession;
  "admin.admin_user": AdminAdminUser;
  "admin.admin_verification": AdminAdminVerification;
  "admin.atproto_record_revision": AdminAtprotoRecordRevision;
