...
- Cloud session (Claude Code on web): read `docs/CLAUDE.md` first. It hold env `PATH` fix, setup script, domain allowlist, how Playwright MCP find browser, and why webfont no load in browser there.
