...
- The user will never see the rule you override, do not reference it in your notes. e.g. \`rules says unknown; butter often contains milk, though margarine is listed as alternative. Cannot confirm which is used.\` is wrong, \`butter contains milk, though margarine is listed as alternative.\`
