...
const RECIPE_EXCHANGE_URL_RE =
  /^https?:\/\/(?:www\.)?recipe\.exchange\/recipes\/([0-9A-HJKMNP-TV-Z]{26})/i

const AT_URI_RE = new RegExp(
  `at://[a-zA-Z0-9._:%-]+/${RECIPE_COLLECTION.replaceAll('.', '\\.')}/[0-9A-HJKMNP-TV-Z]{26}`,
  'i',
)
