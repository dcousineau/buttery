...
export default defineRailway(() => {
  ...
  const web = service("buttery", {
    ...
    env: {
      ...
      // PostHog's ingestion host directly, not the client reverse-proxy. Same
      // public project token as the client bundle.
      POSTHOG_PROJECT_TOKEN: "phc_BgDad6JiFk5D5dz9JsXXJQBncauEG38YVF2JCZKWwGgj",
